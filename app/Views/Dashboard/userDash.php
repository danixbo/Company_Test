...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="container">
            <h1 class="text-4xl text-blue-600 font-bold">Tambah Data User</h1>
            <a href="<?= base_url('dashboard/user/tambah') ?>" class="btn btn-success my-4"><i class="fa-solid fa-plus"></i> Tambah</a>
            ...
            <form class="flex items-center" action="<?= base_url('dashboard/user') ?>" method="post">   
                ...
                <button name="cari" type="submit" class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <?php if ($keyword) : ?>
                        <a href="<?= base_url('dashboard/user') ?>" class="bg-red-600 text-white rounded-lg p-2.5 text-sm font-medium text-gray-600 hover:bg-red-700 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300">
            ...
            <table class="border-collapse border border-slate-500 mt-4 w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border border-slate-600 text-center">Password</th>
                        <th class="border border-slate-600 text-center">Nama</th>
                        <th class="border border-slate-600 text-center">Level</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-700 p-2"><?= $userData['username']?></td>
                        <td class="border border-slate-700 p-2"><?= $userData['password']?></td>
